...
values ('Kadamba', 'ktc', @goatransid, 3, 30, 15.359136354931396,73.922923046875, 15.623816008758071,74.57660957031248, 15.094120426436618,73.26923652343748, 10, 'en', 'Asia/Kolkata', '+912223071528', 'http://www.msrtc.gov.in/');
...
insert into fleet(fleet_name,  parent_fleet_id, fleet_type, avg_speed,cen_lat,cen_lon,ne_lat,ne_lon,sw_lat,sw_lon, zoom, agency_lang,agency_timezone,agency_phone,agency_url) 
values ('MH Transport', 1, 3, 30, 19.131336917005157,77.13573737792969, 21.193809145754596,82.29931159667967, 17.04278759928605,71.97216315917967,7, 'en', 'Asia/Kolkata', '0832-2438034', 'http://ktclgoa.com/' );
